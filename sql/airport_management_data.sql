...
('DL001-002', 'DL001', 'B757-200', 'N302DL', '2017-11-05', '2024-10-20', '2025-01-20', 'Maintenance', 15620.00),
...
-- FLIGHT data (Current and upcoming flights)
INSERT INTO `FLIGHT` (`flight_number`, `airline_id`, `aircraft_id`, `source_airport`, `destination_airport`, `scheduled_departure`, `scheduled_arrival`, `actual_departure`, `actual_arrival`, `status`, `gate`, `terminal`, `delay_minutes`, `flight_date`) VALUES
...
('CREW005', 'EMP003', 'Pilot', 'ATP-99887766', '2025-11-10', '2025-05-25', 12500.00, '2010-03-20', 'Active'),
('CREW006', 'EMP006', 'Co-Pilot', 'CPL-44332211', '2026-02-14', '2025-08-05', 4750.30, '2019-12-10', 'Active');
...
('AA101', '2024-12-20', 'CREW006', 'First_Officer', '2024-12-20 12:30:00', '2024-12-21 00:30:00'),
...
('EK400', '2024-12-21', 'Scheduled', 'Boarding', 'Ready for departure', 'EMP001', '2024-12-21 23:30:00'),
('SQ600', '2024-12-22', 'Boarding', 'Departed', 'Flight departed', 'EMP001', '2024-12-22 01:20:00'),
('DL200', '2024-12-21', NULL, 'Scheduled', 'Initial scheduling', 'SYSTEM', '2024-11-20 10:00:00');


-- passengers for upcoming flights
INSERT INTO `PASSENGER` (`passenger_id`, `first_name`, `last_name`, `date_of_birth`, `gender`, `nationality`, `passport_number`, `passport_expiry`, `email`, `phone`, `frequent_flyer_number`) VALUES
...
-- Additional passenger addresses
INSERT INTO `PASSENGER_ADDRESS` (`passenger_id`, `address_type`, `street_address`, `city`, `state_province`, `postal_code`, `country`) VALUES
...
-- More employees for different departments
INSERT INTO `EMPLOYEE` (`employee_id`, `airport_code`, `airline_id`, `first_name`, `last_name`, `email`, `phone`, `date_of_birth`, `hire_date`, `department`, `position`, `salary`, `status`, `supervisor_id`) VALUES
...
('EMP014', 'CDG', NULL, 'Marie', 'Leclerc', 'marie.leclerc@adp.fr', '+33-1-48-62-0114', '1990-10-08', '2021-06-12', 'Security', 'Security Officer', 45000.00, 'Active', 'EMP002');
...
('CREW009', 'EMP004', 'Purser', 'PR-12345567', '2025-09-15', '2025-03-15', 4520.25, '2016-11-20', 'Active'),
('CREW010', 'EMP010', 'Flight_Attendant', 'FA-77665544', '2026-01-10', '2025-07-10', 980.00, '2022-04-01', 'Training');

-- Additional flight crew assignments
INSERT INTO `FLIGHT_CREW` (`flight_number`, `flight_date`, `crew_id`, `role`, `check_in_time`, `check_out_time`) VALUES
...
('SQ600', '2024-12-22', 'CREW009', 'Chief_Purser', '2024-12-21 23:20:00', '2024-12-22 10:15:00'),
('AA102', '2024-12-22', 'CREW005', 'Captain', '2024-12-22 14:30:00', NULL),
('AA102', '2024-12-22', 'CREW006', 'First_Officer', '2024-12-22 14:30:00', NULL);

-- More aircraft for the fleet
INSERT INTO `AIRCRAFT` (`aircraft_id`, `airline_id`, `aircraft_type_id`, `registration`, `manufacture_date`, `last_maintenance`, `next_maintenance`, `status`, `total_flight_hours`) VALUES
...
('EK001-002', 'EK001', 'A380-800', 'A6-EUZ', '2017-05-18', '2024-11-20', '2025-02-20', 'Maintenance', 16850.80);

-- Additional flight schedules for next few days
INSERT INTO `FLIGHT` (`flight_number`, `airline_id`, `aircraft_id`, `source_airport`, `destination_airport`, `scheduled_departure`, `scheduled_arrival`, `actual_departure`, `actual_arrival`, `status`, `gate`, `terminal`, `delay_minutes`, `flight_date`) VALUES
...
INSERT INTO `EMPLOYEE` (`employee_id`, `airport_code`, `airline_id`, `first_name`, `last_name`, `email`, `phone`, `date_of_birth`, `hire_date`, `department`, `position`, `salary`, `status`) VALUES
('TA001', NULL, NULL, 'Jennifer', 'Chang', 'jennifer.chang@globaltravel.com', '+1-555-2001', '1988-04-12', '2020-03-15', 'Sales', 'Travel Agent', 48000.00, 'Active'),
('TA002', NULL, NULL, 'Marco', 'Rossi', 'marco.rossi@eurotravel.com', '+39-06-1234567', '1985-11-28', '2018-08-20', 'Sales', 'Senior Travel Agent', 55000.00, 'Active');

-- More gates for different airports
INSERT INTO `GATE` (`gate_id`, `airport_code`, `terminal`, `gate_type`, `status`, `aircraft_capacity`) VALUES
...
-- Sample maintenance records and additional aircraft status updates
UPDATE `AIRCRAFT` SET `status` = 'Active', `last_maintenance` = '2024-12-15', `next_maintenance` = '2025-03-15' WHERE `aircraft_id` = 'DL001-002';
UPDATE `AIRCRAFT` SET `total_flight_hours` = 17250.75 WHERE `aircraft_id` = 'EK001-002';

-- Add some cancelled and rescheduled flights for realistic scenarios
INSERT INTO `FLIGHT` (`flight_number`, `airline_id`, `aircraft_id`, `source_airport`, `destination_airport`, `scheduled_departure`, `scheduled_arrival`, `actual_departure`, `actual_arrival`, `status`, `gate`, `terminal`, `delay_minutes`, `flight_date`) VALUES
('AA150', 'AA001', NULL, 'JFK', 'ORD', '2024-12-21 15:30:00', '2024-12-21 17:45:00', NULL, NULL, 'Cancelled', NULL, '4', 0, '2024-12-21'),
('DL250', 'DL001', 'DL001-001', 'LAX', 'ATL', '2024-12-22 09:15:00', '2024-12-22 16:30:00', NULL, NULL, 'Delayed', 'V20', '2', 120, '2024-12-22');
